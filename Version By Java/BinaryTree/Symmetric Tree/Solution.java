 ...
 * 首先有一个误区：就是使用递归判断二叉树，照搬二叉树遍历的框架：将二叉树看成根节点、左子树、右子树三部分，判断根节点满不满足对称二叉树，然后递归的判断左子树和右子树是否满足对称二叉树
 * 以上思路主要的错因在于对对称二叉树的理解出了错对称二叉树，对称二叉树应该是基于中轴线对称，所以将大问题转化为小问题的正确方法是：第一层——判断根节点的左右子树是否对称，推向下一层
 * 判断下一层是否对称
 */
